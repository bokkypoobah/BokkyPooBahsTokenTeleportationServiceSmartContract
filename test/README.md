...
* Geth/v1.7.0-unstable-0cc9b879/darwin-amd64/go1.8.3
...
* The tests were conducted using bash shell scripts running Geth/v1.7.0-unstable-0cc9b879/darwin-amd64/go1.8.3 JavaScript commands
